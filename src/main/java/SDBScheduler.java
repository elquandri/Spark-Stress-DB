...
class SDBScheduler {
    private static final Log LOG = LogFactory.getLog(SDBScheduler.class);
    ...
    public SDBScheduler(String splitFilename,
    ...
    public SDBScheduler(FileSplit[] realSplits,
    ...
    public static void main(String[] args) throws IOException {
        SDBScheduler problem = new SDBScheduler("block-loc.txt", "nodes");
